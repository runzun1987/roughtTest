...
Future<void> init() async {
  ...
  // Repository
  sl.registerLazySingleton(() => GetPriceForumulaRepo());
  ...
  sl.registerLazySingleton(() => ZapexRepo(dioClient: sl()));

  // Provider
  sl.registerFactory(() => CustomImageProvider());
  sl.registerFactory(() => PriceFormulaProvider(priceFormulaRepo: sl()));
  sl.registerFactory(() => PaymentProvider());
  sl.registerFactory(() => ShippingTypeProvider());
  ...
  sl.registerFactory(
      () => ProductDetailsProvider(productDetailsRepo: sl(), zapexRepo: sl()));
  sl.registerFactory(() => SearchProvider(searchRepo: sl(), zapexRepo: sl()));
