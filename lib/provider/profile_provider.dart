...
class ProfileProvider extends ChangeNotifier {
  ...
  Future<ResponseModel> updateUserInfo(
      UserInfoModel updateUserModel, BuildContext context) async {
    ...
    if (apiResponse.response!.statusCode == 200) {
      ...
      // Map<UserAttributeKey, UpdateUserAttributeResult> data =
      //     apiResponse.response.data;
      // data.forEach((UserAttributeKey key, UpdateUserAttributeResult value) {
      //   print(key);
      //   print(value);
      // });
      ...
      responseModel = ResponseModel("Update successful", true);
      // print(message);
    } else {
      print('${apiResponse.response!.statusCode} ${apiResponse.response}');
      responseModel =
          ResponseModel('${apiResponse.response!.statusCode}', false);
    }
    notifyListeners();
