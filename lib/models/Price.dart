...
class Price extends Model {
  ...
  const Price._internal({required this.id, code, createdAt, updatedAt}): _code = code, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Price({String? id, String? code}) {
  ...
  Price copyWith({String? id, String? code}) {
    return Price._internal(
      id: id ?? this.id,
      code: code ?? this.code);
  }
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'code': _code, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };

  static final QueryField ID = QueryField(fieldName: "price.id");
