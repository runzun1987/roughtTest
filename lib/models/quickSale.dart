...
/** This is an auto generated class representing the quickSale type in your schema. */
@immutable
class quickSale extends Model {
  static const classType = const _quickSaleModelType();
  final String id;
  final String? _title;
  ...
  quickSale.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _title = json['title'],
  ...
  static final QueryField ID = QueryField(fieldName: "quickSale.id");
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "quickSale";
    modelSchemaDefinition.pluralName = "quickSales";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.BIGIMAGEURL,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.DESCRIPTION,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.SELLERSHIPPINGPRICE,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.int)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.SKUS_JSON,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.PROP_OBJ,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.BASETYPE,
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.PRODUCTID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.PROVIDER,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.PROVIDER_SLUG,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.CATEGORY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.CATEGORYID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.SUBCATEGORY,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: quickSale.SUBCATEGORYID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
...
class _quickSaleModelType extends ModelType<quickSale> {
  const _quickSaleModelType();
  
  @override
  quickSale fromJson(Map<String, dynamic> jsonData) {
    return quickSale.fromJson(jsonData);
  }
}