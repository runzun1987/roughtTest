...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  addUser() async {
    if (_formKey!.currentState!.validate()) {
      ...
      String _firstName = "Ranjan";
      String _lastName = "Shrestha";
      String _email = "runjawon@gmail.com";
      String _phone = "9843813046";
      String _phoneNumber = _countryDialCode + "9843813046";
      String _password = "22222222";
      String _confirmPassword = "22222222";
      String _deviceId = await SmsAutoFill().getAppSignature;
      ...
      if (_firstName.isEmpty) {
        ...
        register.fName = _firstName;
        register.lName = _lastName;
  ...
  route(bool isRoute, String errorMessage, String phone, String password) {
    if (isRoute) {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
