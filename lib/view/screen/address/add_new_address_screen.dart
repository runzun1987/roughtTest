...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
    ...
    if (widget.isEnableUpdate && widget.address != null) {
      ...
      if (Provider.of<ProfileProvider>(context, listen: false).userInfoModel !=
        ...
        _contactPersonNameController.text =
            '${Provider.of<ProfileProvider>(context, listen: false).userInfoModel!.firstName ?? ''}'
            ' ${Provider.of<ProfileProvider>(context, listen: false).userInfoModel!.lastName ?? ''}';
  ...
  void _checkPermission(Function callback, BuildContext context) async {
    ...
    if (permission == LocationPermission.denied ||
      ...
      InkWell(
          onTap: () async {
            print('444444444444444444444444444444444Ruzun');
            Navigator.pop(context);
