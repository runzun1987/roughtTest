...
import 'BaseIndicator.dart';
import 'BaseIndicatorText.dart';
            ...
            ? Row(
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      children: [
                        FittedBox(child: _customizedTextIndicator(index)),
                        SizedBox(
                          height: 3,
                        ),
                        FittedBox(child: _customizedIndicator(index)),
                      ],
                    ),
                  ),
