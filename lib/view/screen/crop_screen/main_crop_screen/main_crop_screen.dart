...
import 'painter/custom_crop_paint.dart';
...
class CustomCropImage extends StatefulWidget {
...
class _CropImageState extends State<CustomCropImage> {
  ...
  @override
  void didUpdateWidget(CustomCropImage oldWidget) {
