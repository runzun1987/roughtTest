...
class SellerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<ProductProvider>(context, listen: false)
        .initSellerProductList(seller!.seller!.id.toString(), 1, context);
    ScrollController _scrollController = ScrollController();
    String ratting = seller != null && seller!.avgRating != null
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(
              title: '${seller!.seller!.fName}' + ' ' '${seller!.seller!.lName}'),
          Expanded(
            child: ListView(
                ...
                Padding(
                  ...
                  child: ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      fit: BoxFit.cover,
                      image:
                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/banner/${seller!.seller!.shop != null ? seller!.seller!.shop!.banner : ''}',
                    ...
                    Row(children: [
                      ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          fit: BoxFit.cover,
                          image:
                              '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.shopImageUrl}/${seller!.seller!.shop!.image}',
                          imageErrorBuilder: (c, o, s) => Image.asset(
                              Images.placeholder,
                              height: 80,
                              width: 80,
