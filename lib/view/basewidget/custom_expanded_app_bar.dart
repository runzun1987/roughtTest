...
class CustomExpandedAppBar extends StatefulWidget {
  final String? title;
  final Widget child;
  ...
  @override
  State<CustomExpandedAppBar> createState() => _CustomExpandedAppBarState();
}

class _CustomExpandedAppBarState extends State<CustomExpandedAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: widget.isGuestCheck
          ? isGuestMode
              ? null
              : widget.bottomChild
          : widget.bottomChild,
